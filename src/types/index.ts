...
export type ReadS19Payload = {
totalFullSRecords: number;
      sRecords: FullSRecordReferenceStructure[];
      totalDataSize: number
}

export interface ReadS19Response extends StandardisedResponse {
  payload: ReadS19Payload;
}


export type S19String = string;

export interface WriteS19Response extends StandardisedResponse {
  payload: S19String;
}
